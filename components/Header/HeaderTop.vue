<template>
    <div class="top-header-container w-full fixed lg:relative xl:relative">
        <div class="bg-red-100 w-full flex justify-center py-5">
            <div class="top-header-wrapper w-full flex px-8 lg:px-16 xl:px-16 h-8 sm:h-12 md:h-14 lg:h-16 xl:h-16" style="max-width: 1280px">
...
export default {
    ...
    methods: {
        setIsOpenMobileNav() {
            this.isOpenMobileNav = !this.isOpenMobileNav
        }
    }
}
</script>
